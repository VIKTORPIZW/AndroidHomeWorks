...
import by.it.academy.app7_coroutines.functions.createDirectory
import by.it.academy.app7_coroutines.functions.saveImage
...
class AddCarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBack.setOnClickListener { finishActivity() }
